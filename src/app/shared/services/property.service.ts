...
export class PropertyService {
  ...
  getLandlordByPropertyId(propertyId: number): Observable<any> {
    return this.http.get(Environment.api+`property/${propertyId}/user`);
  }
  RequestExploration(contact: Contact): Observable<any> {
    return this.http.post(Environment.api + 'users/send-email', contact);
  }
